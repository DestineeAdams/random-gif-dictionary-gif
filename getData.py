...
def parseGif( word):
    ...
    if response.status_code == 200:
        ...
        try:
          return rawJson["data"][0]["url"]
          
        except:
        
            print("somthing went wrong ========== parseGif")
            return "https://media.giphy.com/media/UoeaPqYrimha6rdTFV/giphy.gif"
...
def getContent():  
    ...
    if r.status_code == 200:
        ...
        return  {"word":"404", "definition":"A 404 error is an HTTP status code that means that the page you were trying to reach on a website couldn't be found on their server.", "gifURL":"https://media.giphy.com/media/UoeaPqYrimha6rdTFV/giphy.gif"}
